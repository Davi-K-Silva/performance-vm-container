c     double precision aa(200,200),a(201,200),b(200),x(200)
c     double precision time(8,7),cray,ops,total,norma,normx
c     double precision resid,residn,eps,epslon
c     integer ipvt(200)
c     lda = 201
c     ldaa = 200
c
...
c
c     n = 100 
c --- change array sizes ---
      double precision aa(3000,3000),a(3001,3000),b(3000),x(3000)
